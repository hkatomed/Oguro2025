## original note: 20250427_motifHits_EightBase_1.R.txt
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(compareDF, file = "20250427_EightBase_4940.xlsx")

setwd("../RData")
save(compareDF, file = "20250427_EightBase_4940.RData")
...
for(j in 1:length(PATTERNS1)){
	PATTERN <- PATTERNS1[j]
	colName <- paste(PATTERN, "_m", MAX.MISMATCH, sep = "")
	if(PATTERN != ""){
	cat(j, ", ", PATTERN, "\n", sep = "")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(matchDFlist, file = "20250427_matchDFlist_EightBase_4940.xlsx")

setwd("../RData")
save(matchDFlist, file = "20250427_matchDFlist_EightBase_4940.RData")
...
load(file = "20250427_matchDFlist_EightBase_4940.RData")
...
NewDF2 <- NewDF[, c(1, 6, 15, 20, 43:54, 33:42)]
...
setwd("motifHits")
setwd("RData")
save(NewDF2, file = "20250427_NewDF2_EightBase.RData")

setwd("../XLSX")
write.xlsx(NewDF2, file = "20250427_NewDF2_EightBase.xlsx")
...
setwd("motifHits")
setwd("RData")
load(file = "20250427_NewDF2_EightBase.RData")	
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(outList, file = "20250427_motifHits_4940_EightBase.xlsx")
