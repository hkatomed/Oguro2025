## original note: 20250516_Asano_motif_1.R.txt
...
for(i in 1:nrow(AsanoDF2)){
	...
	AsanoDF2$CDS_200bp[i] <- substr(x = CDS, start = 1, stop = 200)
}
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(compareDF, file = "20250516_EightBase_200base.xlsx")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(matchDF, file = "20250516_matchDF_EightBase_200base.xlsx")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(outList, file = "20250516_motifEnrichment_EightBase_200base.xlsx")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(outList2, file = "20250516_motifEnrichment_EightBase_p0.05_topHits2_200base.xlsx")
...
setwd("motifHits")
setwd("XLSX")
inDF <- read.xlsx(xlsxFile = "20250516_EightBase_200base.xlsx")

Index <- seq(2, 492, 2)
outDF <- inDF[Index, ]

write.xlsx(outDF, file = "20250516_EightBase_hits_200base.xlsx")
