...
#### GUCG only #################################################
## finally generates 20241226_motifHits_4940_GTCG.xlsx
## 20241226_GTCGonly_notes.zip
## original note: 20241226_Asano_motif_1_CDSeach2_GTCGonly.txt
## original note: 20241226_Asano_motif_2_GTCGonly.txt
## original note: 20241226_Asano_motif_3_GTCGonly.txt



## 20241226_Asano_motif_1_CDSeach2_GTCGonly.txt ###############
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(compareDF, file = "20241226_GTCG_4940.xlsx")

setwd("../RData")
save(compareDF, file = "20241226_GTCG_4940.RData")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(matchDFlist, file = "20241226_matchDFlist_GTCG_4940.xlsx")

setwd("../RData")
save(matchDFlist, file = "20241226_matchDFlist_GTCG_4940.RData")



## 20241226_Asano_motif_2_GTCGonly.txt ########################
...
load(file = "20241226_matchDFlist_GTCG_4940.RData")
...
setwd("motifHits")
setwd("RData")
save(NewDF2, file = "20241226_NewDF2_GTCG.RData")

setwd("../XLSX")
write.xlsx(NewDF2, file = "20241226_NewDF2_GTCG.xlsx")




## 20241226_Asano_motif_3_GTCGonly.txt ########################

setwd(HOMEDIR)
setwd("data")
setwd("motifHits")
setwd("RData")
load(file = "20241226_NewDF2_GTCG.RData")	# NewDF2
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(outList, file = "20241226_motifHits_4940_GTCG.xlsx")
