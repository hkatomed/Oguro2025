## original note: 	20250516_EightBase_sliding9base_1base_in200base.R.txt
##			20250516_EightBase_sliding1base_1base_in200base.R.txt
##			20250516_EightBase_sliding15base_1base_in200base.R.txt
##			20250516_EightBase_sliding18base_1base_in200base.R.txt
##			20250516_EightBase_sliding21base_1base_in200base.R.txt
##			20250516_EightBase_sliding24base_1base_in200base.R.txt
##			20250516_EightBase_sliding27base_1base_in200base.R.txt
...
setwd("motifHits")
setwd("XLSX")
EightBase_hits <- read.xlsx(xlsxFile = "20250516_EightBase_hits_200base.xlsx", colNames = TRUE)
...
fileName <- paste(DAY, "_EightBase_slope_LEN", slideLEN, "_", baseNum, "base_in200base.pdf", sep = "")
pdf(file = fileName)
...
DAY <- gsub(pattern = "-", replacement = "", x = as.character(Sys.Date()))
fileName2 <- paste(DAY, "_EightBase_hits_LEN", slideLEN, "_", baseNum, "base_in200base.pdf", sep = "")
pdf(file = fileName2)
...
outList <- list(EightBase_hits = EightBase_hits, 
		...
		bases_x_to_y = out3)
DAY <- gsub(pattern = "-", replacement = "", x = as.character(Sys.Date()))
fileName3 <- paste(DAY, "_EightBase_slope_LEN", slideLEN, "_", baseNum, "base_in200base.xlsx", sep = "")
