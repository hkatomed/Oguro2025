...
#### 6thTrial + NGUCGNN ##############################
## finally generates: 20241216_motifHits_4940.xlsx
## 20241216_6thTrialPlusNGTCGNN_notes.zip
## original: 20241216_Asano_motif_1_CDSeach2.txt
## original: 20241216_Asano_motif_2.txt 
## original: 20241216_Asano_motif_3.txt 


## 20241216_Asano_motif_1_CDSeach2.txt
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(compareDF, file = "20241216_AGYYGRY_6thTrialPlusGTCG_4940.xlsx")

setwd("../RData")
save(compareDF, file = "20241216_AGYYGRY_6thTrialPlusGTCG_4940.RData")
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(matchDFlist, file = "20241216_matchDFlist_6thTrialPlusGTCG_4940.xlsx")

setwd("../RData")
save(matchDFlist, file = "20241216_matchDFlist_6thTrialPlusGTCG_4940.RData")



## 20241216_Asano_motif_2.txt 
...
load(file = "20241216_matchDFlist_6thTrialPlusGTCG_4940.RData")
...
setwd("motifHits")
setwd("RData")
save(NewDF2, file = "20241216_NewDF2_6thTrialPlusGTCG.RData")

setwd("../XLSX")
write.xlsx(NewDF2, file = "20241216_NewDF2_6thTrialPlusGTCG.xlsx")



## 20241216_Asano_motif_3.txt 

setwd(HOMEDIR)
setwd("data")
setwd("motifHits")
setwd("RData")
load(file = "20241216_NewDF2_6thTrialPlusGTCG.RData")	# NewDF2
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(outList, file = "20241216_motifHits_4940.xlsx")
