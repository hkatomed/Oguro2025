...
#### NewDF ########################################
## original note: 20240522_AsanoTE_1.txt
## original note: 20240619_AsanoTE_1.txt
## finally generates: 20240619_NewDF.RData


## 20240522_AsanoTE_1.txt #########################
...
write.xlsx(poneSpecificDF, file = "20240522_poneSpecific.xlsx")
...
write.xlsx(RPKMtableSpecificDF, file = "20240522_RPKMtableSpecific.xlsx")
...
write.xlsx(NewDF, file = "20240522_RPKMtable_merged_with_pone_match4496_with444.xlsx")



## 20240619_AsanoTE_1.txt #########################
...
setwd("motifHits")
setwd("XLSX")
write.xlsx(list(No246 = No246, Top246 = Top246, Middle246 = Middle246, Bottom246 = Bottom246, All = All), file = "20240619_S4_246_genes.xlsx")
write.xlsx(list(NoRPgenes = NoRPgenes, RPSgenes = RPSgenes, RPLgenes = RPLgenes, All = All), file = "20240619_RP_genes.xlsx")

setwd("../RData")
save(NewDF, file = "20240619_NewDF.RData")
