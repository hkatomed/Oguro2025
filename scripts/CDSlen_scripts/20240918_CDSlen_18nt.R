## This file is based on 20240614_Asano_motif_1_18nt.txt
...
length(which(is.na(RPKMtable$CDS_18bp) == TRUE))
...
# > head(AsanoDF, n = 3)
#      Gene           CDS_18bp
# 1 YJL153C ATGACAGAAGATAATATT
# 2 YOL154W ATGAAGTTCTCTTCCGGC
# 3 YDR206W ATGGAACCATCGAATACC
...
for(i in 1:length(matchList)){
	...
	matchLines[(i-1)*2+1] <- AsanoDF$CDS_18bp[i]
...
setwd(HOMEDIR)
setwd("XLSX")
write.xlsx(compareDF, file = "20240614_AGYYGRY_6thTrial_4940_18bp.xlsx")
...
# > colnames(matchDF)
#  [1] "Gene"      "CDS_18bp"  "AGYYGNN"   "NGYYGRN"   "NNYYGRY"   "NGYYGRY"  
...
matchDF$hit[is.na(matchDF$CDS_18bp) == TRUE] <- NA


setwd(HOMEDIR)
setwd("XLSX")
write.xlsx(matchDF, file = "20240614_matchDF_6thTrial_4940_18bp.xlsx")
