## This file is based on 20240614_Asano_motif_1_28to51.txt
...
length(which(is.na(RPKMtable$CDS_28to51) == TRUE))
...
# > head(AsanoDF, n = 3)
#      Gene               CDS_28to51
# 1 YJL153C ACCTCCGTTAAAGTAGTTACCGAC
# 2 YOL154W ATCTTTGCAACTATTGCTTCTCTA
# 3 YDR206W GATCTTCCTACCGCTTTTAATGGT
...
for(i in 1:length(matchList)){
	...
	matchLines[(i-1)*2+1] <- AsanoDF$CDS_28to51[i]
...
setwd(HOMEDIR)
setwd("XLSX")
write.xlsx(compareDF, file = "20240614_AGYYGRY_6thTrial_4940_28to51.xlsx")
...
# > colnames(matchDF)
#  [1] "Gene"      "CDS_28to51"  "AGYYGNN"   "NGYYGRN"   "NNYYGRY"   "NGYYGRY"  
...
matchDF$hit[is.na(matchDF$CDS_28to51) == TRUE] <- NA


setwd(HOMEDIR)
setwd("XLSX")
write.xlsx(matchDF, file = "20240614_matchDF_6thTrial_4940_28to51.xlsx")
